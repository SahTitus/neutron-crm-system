...
export const OverviewCard = ({ label, icon, value, percentage, change, showSinceLastMonth }) => {
  return (
    <div className="flex flex-col justify-between h-28 bg-white shadow-sm shadow-slate-400 dark:shadow-2xl dark:shadow-slate-700 dark:bg-gray-900 rounded-lg p-4">
