...
export const CampaignCard = ({ campaign, anchorEl, handleMenuOpen, handleDelete, handleMenuClose }) => {
  ...
  return (
    <div className="mb-6 p-6 rounded-3xl bg-white dark:bg-gray-800 dark:hover:bg-gray-700 transition-colors duration-500 shadow-lg hover:shadow-md transform hover:-translate-y-1 cursor-pointer">
      <div className="flex justify-between items-center">
        ...
        <MoreVert className="cursor-pointer" onClick={(event) => handleMenuOpen(event, campaign._id)} />
        <Menu
          anchorEl={anchorEl}
      ...
      {isExpanded && (
        <div className="mt-6">
          ...
          <div
            className="prose dark:prose-invert prose-blue max-w-none mt-4 bg-gray-50 dark:bg-[#252f3f] p-4 rounded-xl"
