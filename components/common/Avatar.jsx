...
export const AvatarIcon = ({ image, alt, name, email }) => {
    return (
        <Link className={`flex items-center shadow-sm dark:bg-transparent bg-slate-100 dark:shadow-inner w-full max-w-96 dark:shadow-slate-400 shadow-slate-400 rounded-md px-3 py-[5px] transition-all duration-300 ${image ? "" : "animate-pulse"}`} href={routes.settings}>
